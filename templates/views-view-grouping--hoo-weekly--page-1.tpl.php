...
if (!function_exists("_print_days")) {
  function _print_days()
  {
    ...
    $today = date('l', time());
    $days_html = '<colgroup><col class="contentcol"><col class="contentcol"><col class="contentcol"><col class="contentcol"><col class="contentcol"><col class="contentcol"><col class="contentcol"></colgroup>';
    $days_html  .= '<thead>';
    $days_html .=   '<tr>';
